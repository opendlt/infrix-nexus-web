...
import { STAGES, STAGE_INDEX } from '/lib/spineCommon.js';
import { subscribe } from '/lib/spineBus.js';
import { subscribe2, refreshSlice } from '/lib/store.js';

// One canonical STAGES source (RUNBOOK-02 Task 1) — imported, never re-declared.
const KEY_INDEX = STAGE_INDEX; // intent→1 … anchor→7
